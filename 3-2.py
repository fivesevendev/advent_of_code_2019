...
def numFind(n):
    ...
    for t in lfOne:
        if t in lfTwo:
            intersect.append(t)
    for i in intersect:
        if lfOne[i] + lfTwo[i] < taxi:
            taxi = lfOne[i] + lfTwo[i]
    return taxi
